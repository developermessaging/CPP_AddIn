========================================================================
    ACTIVE TEMPLATE LIBRARY : CPPComAddIn Project Overview
========================================================================

AppWizard has created this CPPComAddIn project for you to use as the starting point for
...
CPPComAddIn.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (CPPComAddIn.h)
        GUID definitions                                (CPPComAddIn_i.c)
        A type library                                  (CPPComAddIn.tlb)
        Marshaling code                                 (CPPComAddIn_p.c and dlldata.c)

CPPComAddIn.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in CPPComAddIn.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named CPPComAddIn.pch and a precompiled types file named StdAfx.obj.
...
CPPComAddInps.vcxproj
	...
	dlldata.c, CPPComAddIn_i.c and CPPComAddIn_p.c which are required
	to build the proxy/stub DLL.

CPPComAddInps.vcxproj.filters
